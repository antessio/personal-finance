...
export const mockTransactions: Transaction[] = [
  ...
  { id: 't-2025-001', date: '2025-01-31', description: 'January Salary', amount: 3200.00, account: 'account-1', categoryId: 'cat-income-1', included: true },
  { id: 't-2025-002', date: '2025-01-30', description: 'Whole Foods Market', amount: -125.45, account: 'account-1', categoryId: 'cat-expense-1', included: true },
  { id: 't-2025-003', date: '2025-01-29', description: 'Starbucks Coffee', amount: -6.85, account: 'account-3', categoryId: 'cat-expense-6', included: true },
  { id: 't-2025-004', date: '2025-01-28', description: 'Gas Station', amount: -45.20, account: 'account-2', categoryId: 'cat-expense-2', included: true },
  { id: 't-2025-005', date: '2025-01-27', description: 'Netflix Subscription', amount: -17.99, account: 'account-4', categoryId: 'cat-subs-1', included: true },
  { id: 't-2025-006', date: '2025-01-26', description: 'Electric Bill', amount: -135.00, account: 'account-1', categoryId: 'cat-bills-1', included: true },
  { id: 't-2025-007', date: '2025-01-25', description: 'Target Shopping', amount: -89.99, account: 'account-2', categoryId: 'cat-expense-8', included: true },
  { id: 't-2025-008', date: '2025-01-24', description: 'Doctor Visit', amount: -150.00, account: 'account-1', categoryId: 'cat-expense-3', included: true },
  { id: 't-2025-009', date: '2025-01-23', description: 'Freelance Project', amount: 850.00, account: 'account-2', categoryId: 'cat-income-3', included: true },
  { id: 't-2025-010', date: '2025-01-22', description: 'Restaurant Dinner', amount: -65.40, account: 'account-3', categoryId: 'cat-expense-6', included: true },
  { id: 't-2025-011', date: '2025-01-21', description: 'Gym Membership', amount: -29.99, account: 'account-4', categoryId: 'cat-subs-4', included: true },
  { id: 't-2025-012', date: '2025-01-20', description: 'Grocery Store', amount: -78.32, account: 'account-1', categoryId: 'cat-expense-1', included: true },
  { id: 't-2025-013', date: '2025-01-19', description: 'Phone Bill', amount: -55.00, account: 'account-1', categoryId: 'cat-bills-3', included: true },
  { id: 't-2025-014', date: '2025-01-18', description: 'Amazon Purchase', amount: -145.67, account: 'account-4', categoryId: 'cat-expense-8', included: true },
  { id: 't-2025-015', date: '2025-01-17', description: 'Movie Theater', amount: -28.00, account: 'account-2', categoryId: 'cat-expense-7', included: true },
  { id: 't-2025-016', date: '2025-01-16', description: 'Emergency Fund Transfer', amount: -500.00, account: 'account-1', categoryId: 'cat-savings-1', included: true },
  { id: 't-2025-017', date: '2025-01-15', description: 'Internet Bill', amount: -79.99, account: 'account-1', categoryId: 'cat-bills-2', included: true },
  { id: 't-2025-018', date: '2025-01-14', description: 'Coffee Shop', amount: -4.75, account: 'account-3', categoryId: 'cat-expense-6', included: true },
  { id: 't-2025-019', date: '2025-01-13', description: 'Spotify Premium', amount: -10.99, account: 'account-4', categoryId: 'cat-subs-2', included: true },
  { id: 't-2025-020', date: '2025-01-12', description: 'Water Bill', amount: -35.00, account: 'account-1', categoryId: 'cat-bills-4', included: true },

  // 2024 Transactions - December
  { id: 't-2024-120', date: '2024-12-31', description: 'December Salary', amount: 3200.00, account: 'account-1', categoryId: 'cat-income-1', included: true },
  { id: 't-2024-121', date: '2024-12-30', description: 'Year-End Bonus', amount: 1500.00, account: 'account-2', categoryId: 'cat-income-5', included: true },
  { id: 't-2024-122', date: '2024-12-29', description: 'Holiday Shopping', amount: -350.00, account: 'account-4', categoryId: 'cat-expense-8', included: true },
  { id: 't-2024-123', date: '2024-12-28', description: 'Restaurant', amount: -95.50, account: 'account-3', categoryId: 'cat-expense-6', included: true },
  { id: 't-2024-124', date: '2024-12-27', description: 'Gas Station', amount: -42.30, account: 'account-2', categoryId: 'cat-expense-2', included: true },
  { id: 't-2024-125', date: '2024-12-26', description: 'Groceries', amount: -156.78, account: 'account-1', categoryId: 'cat-expense-1', included: true },
  { id: 't-2024-126', date: '2024-12-25', description: 'Gift Shopping', amount: -200.00, account: 'account-4', categoryId: 'cat-expense-8', included: true },
  { id: 't-2024-127', date: '2024-12-24', description: 'Electric Bill', amount: -142.50, account: 'account-1', categoryId: 'cat-bills-1', included: true },
  { id: 't-2024-128', date: '2024-12-23', description: 'Retirement Contribution', amount: -600.00, account: 'account-2', categoryId: 'cat-savings-2', included: true },
  { id: 't-2024-129', date: '2024-12-22', description: 'Amazon Prime', amount: -14.99, account: 'account-4', categoryId: 'cat-subs-3', included: true },
