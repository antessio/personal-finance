  ...
  def button(assigns) do
    ...
    <button
      ...
      class={[
        ...
        "rounded-md bg-blue-600 px-6 py-3 text-base font-semibold text-white hover:bg-blue-500",
        @class
      ]}
      {@rest}
    >
  ...
  def table(assigns) do
    ...
    <div class="flex justify-center">
      <div class="overflow-y-auto px-4 sm:overflow-visible sm:px-0">
        <table class="w-[40rem] mt-11 sm:w-full bg-white rounded-lg shadow-sm">
          <thead class="text-sm text-left leading-6 text-zinc-500">
            <tr>
              <th :for={col <- @col} class="px-5 py-2 pb-4 pr-6 font-normal">{col[:label]}</th>
          ...
          >
            <tr :for={row <- @rows} id={@row_id && @row_id.(row)} class="group">
              <td
                ...
                class={["relative p-0 px-5", @row_click && "hover:cursor-pointer"]}
              >
              ...
              <td :if={@action != []} class="relative w-14 px-5">
